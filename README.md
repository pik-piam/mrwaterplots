...
R package **mrwaterplots**, version **1.0.14**
...
Beier F, Heinke J, von Jeetze P, Dietrich J (2023). _mrwaterplots: plotting library for mrwater outputs_. R package version 1.0.14, <https://github.com/pik-piam/mrwaterplots>.
