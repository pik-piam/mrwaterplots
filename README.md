...
R package **mrwaterplots**, version **1.0.16**
...
Beier F, Heinke J, von Jeetze P, Dietrich J (2023). _mrwaterplots: plotting library for mrwater outputs_. R package version 1.0.16, <https://github.com/pik-piam/mrwaterplots>.
